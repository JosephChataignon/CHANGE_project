...
model.save_pretrained( data_dir + "fine_tuned_pythia-1b-Walser")
tokenizer.save_pretrained( data_dir + "fine_tuned_pythia-1b-Walser") #i did not change the tokenizer ?
